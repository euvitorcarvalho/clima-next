...
export default function Filters() {
  ...
  return (
    <div className="flex flex-col sm:py-3.5 py-2 px-7.5 sm:flex-row items-center justify-center max-w-182.5 w-full sm:gap-9.5 gap-4 sm:h-26 bg-(--surface) rounded-xl">
      <p className="sm:text-[27px] flex flex-row justify-center items-center gap-1 text-foreground font-medium">
        Filters
        <ChevronDown
